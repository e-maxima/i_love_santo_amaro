...
import 'package:ILoveSantoAmaro/model/order.dart';
import 'package:ILoveSantoAmaro/model/product.dart';
import 'package:ILoveSantoAmaro/model/user.dart';
import 'package:ILoveSantoAmaro/services/order.dart';
import 'package:ILoveSantoAmaro/services/users.dart';
...
//  getter
  ...
  Future<bool> signUp(String name, String email, String password) async {
    try {
      ...
      _status = Status.Unauthenticated;
      notifyListeners();
      print('erro ocorrido ' + e.toString());
      return false;
    }
  }
  ...
  Future<void> _onStateChanged(FirebaseUser user) async {
    if (user == null) {
      ...
      print('_userModel.id ' + _userModel.id);
      if (_userModel.id == '') {
        _status = Status.Unauthenticated;
      } else {
